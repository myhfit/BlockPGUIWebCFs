...
import bp.ui.actions.BPWebSiteConsolePanelActions;
...
public class BPWebSiteConsolePanel extends JPanel implements BPEditor<JPanel>, BPViewer<BPTextContainer>
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -3622925082037325531L;
	...
	protected void init()
	{
		...
		m_lblwb = new BPLabel(" @");
		BPWebSiteConsolePanelActions acts = new BPWebSiteConsolePanelActions(this);
		...
		// add(m_scrolltree, BorderLayout.WEST);
	...
	public void test()
	{
		...
		BPWebOperation op = BPWebOperationBase.build(verb).setPath(path).setHeaderFields(getHeaders()).getOperation();
	...
	{
		String[][] rc = new String[][] { new String[] { "User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/109.0" }, new String[] { "Accept", "text/html,application/xhtml+xml,application/xml" },
				new String[] { "Accept-Language", "zh-CN,zh;q=0.9,zh-TW;q=0.7,zh-HK;q=0.6,en-US;q=0.4,en;q=0.3,ja;q=0.1" }, new String[] { "Accept", "*/*" } };
		return rc;
	}
	...
	public final static class BPEditorFactoryWebSiteConsole implements BPEditorFactory
	{
